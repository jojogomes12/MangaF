      ...
      <form action="<?= $Base_URL ?>user_process.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="submit"  class="btn card-btn" id="card-btn" value="Alterar">
          </div>
          <div class="col-md-4">
            <div id="profile-image-container" style="background-image: url('img/usuarios/<?= $userData->image ?>')"></div>
            <div class="form-group">
      ...
      <div class="row" id="change-password-container">
        <div class="col-md-4">
          ...
          <form action="<?= $BASE_URL ?>user_process.php" method="POST">
            ...
            <input type="submit"  class="btn card-btn" id="card-btn" value="Alterar Senha">
          </form>
        </div>
      </div>
    </div>
